function [quality, quality_map] = computeImageQualityIndex(img1, img2, block_size)
%========================================================================
...
%            range of [-1, 1] (The best value is 1).
...
%
%   % Choice 1 (suggested):
%   [qi qi_map] = computeImageQualityIndex(img1, img2);
%
%   % Choice 2:
%   [qi qi_map] = computeImageQualityIndex(img1, img2, BLOCK_SIZE);
%
